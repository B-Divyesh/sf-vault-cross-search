...
function renderDemo() {
  ...
  root.innerHTML = `
    ...
    <footer><a class="wordmark" href="/"><span class="mark" aria-hidden="true"></span>Vault Cross Search</a><p>Bundled sample metadata is isolated in this browser only.</p><nav aria-label="Legal"><a href="/privacy/">Privacy</a><a href="/terms/">Terms</a></nav></footer>`;
