...
function renderDemo() {
  ...
  root.innerHTML = `
    ...
    <footer><a class="wordmark" href="/"><span class="mark" aria-hidden="true"></span>Vault Cross Search</a><p>Bundled sample metadata is isolated in this browser only.<br><span class="build-id">Built by Param Factory · Build v0.1.2</span></p><nav aria-label="Legal"><a href="/demo/" aria-current="page">Demo</a><a href="/privacy/">Privacy</a><a href="/terms/">Terms</a></nav></footer>`;
