...
if [ "$(uname -s)" = "Darwin" ]; then
  ...
  echo "Installed Vault Cross Search in /Applications. The unsigned first build may require right-click → Open."
else
  DEST="$HOME/.local/bin/vault-cross-search.AppImage"
